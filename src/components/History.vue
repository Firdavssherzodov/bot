  ...
  >
    ...
    <section class="xl:w-[75%] w-10/12 m-auto bg-slate-100 rounded-lg my-10 py-5">
      <div class="w-[25%] rounded-xl pb-8 bg-white m-5 text-black shadow hover:shadow-md">
        ...
        <p class="font-sans px-3 py-2">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit deleniti
          modi ab incidunt soluta vitae, doloribus, porro illum possimus, minus
          nihil! Sunt, recusandae est autem iure eligendi vero nesciunt
          doloremque.
        </p>
      </div>
    </section>
